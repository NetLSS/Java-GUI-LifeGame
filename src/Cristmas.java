...
class back extends JPanel { // 배경에 그림 넣을 부분
    private int nCase;
...
public class Cristmas extends JFrame {
    back bk = new back();
    public Cristmas(){
        this("Cristmas");
    }
    public Cristmas(String title) {
        super(title);
        ...
        setLocation(screenSize.width/2-325, screenSize.height/2-250);
    ...
    ActionListener al = new ActionListener(){
        public void actionPerformed(ActionEvent e){
            if(e.getActionCommand().equals("트리1")) { // 눌린 버튼이 트리1과 같으면 back의 setnCase로 감
